...
$(document).ready(function () {
    ...
    $('#close-calu-preview').on('click', function () {
        $('#caluPreview').attr('src', 'images/ciobanesc-alb-elvetian/individual-gallery/calu/big/1.JPG');
    });
    ...
    $('#close-beauty-preview').on('click', function () {
        $('#beautyPreview').attr('src', 'images/ciobanesc-alb-elvetian/individual-gallery/beauty/big/1.jpg');
    });
    ...
    $('#close-iris-preview').on('click', function () {
        $('#irisPreview').attr('src', 'images/ciobanesc-alb-elvetian/individual-gallery/iris/big/1.jpg');
    });
    ...
    $('#close-bobby-preview').on('click', function () {
        $('#bobbyPreview').attr('src', 'images/kleinspitz-pomeranian/individual-gallery/bobby/big/1.jpg');
    });
    ...
    $('#close-zorro-preview').on('click', function () {
        $('#zorroPreview').attr('src', 'images/kleinspitz-pomeranian/individual-gallery/zorro/big/1.JPG');
    });
    ...
    $('#close-zefyr-preview').on('click', function () {
        $('#zefyrPreview').attr('src', 'images/kleinspitz-pomeranian/individual-gallery/zefyr/big/1.jpg');
    });
    ...
    $('#close-lili-preview').on('click', function () {
        $('#liliPreview').attr('src', 'images/kleinspitz-pomeranian/individual-gallery/lili/big/1.jpg');
    });
    ...
    $('#close-zita-preview').on('click', function () {
        $('#zitaPreview').attr('src', 'images/kleinspitz-pomeranian/individual-gallery/zita/big/1.jpg');
    });
    ...
    $('#close-linda-preview').on('click', function () {
        $('#lindaPreview').attr('src', 'images/kleinspitz-pomeranian/individual-gallery/linda/big/1.jpg');
    });
    ...
    $('#close-princess-preview').on('click', function () {
        $('#princessPreview').attr('src', 'images/kleinspitz-pomeranian/individual-gallery/princess/big/1.JPG');
    });
    ...
    $('#close-mozzart-preview').on('click', function () {
        $('#mozzartPreview').attr('src', 'images/persana-chinchilla/individual-gallery/mozzart/big/1.jpg');
    });
    ...
    $('#close-greta-preview').on('click', function () {
        $('#gretaPreview').attr('src', 'images/persana-chinchilla/individual-gallery/greta/big/1.jpg');
    });
    ...
    $('#close-szofia-preview').on('click', function () {
        $('#szofiaPreview').attr('src', 'images/persana-chinchilla/individual-gallery/szofia/big/1.jpg');
    });
    ...
    $('#close-dalia-preview').on('click', function () {
        $('#daliaPreview').attr('src', 'images/persana-chinchilla/individual-gallery/dalia/big/1.jpg');
    });
    ...
    $('#close-billieJean-preview').on('click', function () {
        $('#billieJeanPreview').attr('src', 'images/persana-chinchilla/individual-gallery/billiejean/big/1.jpg');
    });
});
